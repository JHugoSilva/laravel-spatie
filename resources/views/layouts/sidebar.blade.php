        ...
        <div
            ...
            <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul class="flex flex-col space-y-1">
                    ...
                    <hr class="text-gray-100 opacity-30 w-1/2 ml-2">
                    <li>
                    ...
                    <li class="text-gray-400 text-[14px] ml-2">Settings</li>
                    <hr class="text-gray-100 opacity-30 w-1/2 ml-2">
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            <x-nav-link :href="route('logout')"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" class="flex-shrink-0 size-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
