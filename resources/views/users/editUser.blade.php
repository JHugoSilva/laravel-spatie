                    ...
                    <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-9">
                            <div class="flex items-center gap-5">
                                ...
                                src="{{ asset('/images/'.$user->photo_profile) }}" alt="Avatar">
                        ...
                        <div class="sm:col-span-9">
                            <input id="af-account-full-name" type="text" name="name" value="{{ $user->name }}"
                        ...
                        <div class="sm:col-span-9">
                            <input id="af-account-email" type="email" name="email" value="{{ $user->email }}"
                        ...
                        <div class="sm:col-span-9">
                            <div class="space-y-2">
                                <input id="af-account-password" type="text" name="password"
                                    ...
                                    <span class="text-sm dark:text-gray-300">Digite a senha de forma opcional</span>
                                @error('password')
                                    <span class="text-red-400 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="sm:col-span-9">
                            <textarea id="description" name="address"
                                ...
                                rows="6" placeholder="Type your message...">{{ $user->address }}</textarea>
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Grid -->
